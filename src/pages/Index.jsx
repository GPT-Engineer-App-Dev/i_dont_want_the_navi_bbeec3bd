        ...
        <Flex>
          ...
          <Box flex="1" bg="gray.100" p={4}>
            ...
            {currentStep === 3 && (
              <VStack spacing={4}>
                <FormControl>
                  <FormLabel htmlFor="backgroundImage">Background Image URL</FormLabel>
                  <Input id="backgroundImage" placeholder="Enter image URL" />
                </FormControl>
                <Flex justifyContent="space-between" width="100%">
                  <Button onClick={handlePrevStep}>Previous</Button>
                  <Button onClick={handleNextStep}>Next</Button>
            ...
            {currentStep === 4 && (
              <VStack spacing={4}>
                ...
                <Flex justifyContent="space-between" width="100%">
                  <Button onClick={handlePrevStep}>Previous</Button>
                  <Button onClick={() => {}}>Download Canvas</Button>
                </Flex>
              </VStack>
            )}
          </Box>
